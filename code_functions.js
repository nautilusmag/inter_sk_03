...
function createCircle(world, x, y, radius, options) 
{
	...
	body_def.position.Set(x/scale , (game.screen_height-(y/scale)));
	body_def.linearDamping = options.linearDamping;
	body_def.angularDamping = options.angularDamping;
	body_def.type = options.type;
	var b = world.CreateBody( body_def );
...
//console.log(dd);
circ.body = createCircle(world, x, y,rd ,{ 'density' : 2.0 });
//circ.body = createCircle(world, x, (game.screen_height*scale)-y,rd ,{ 'density' : 2.0 });
